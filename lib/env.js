...
export const env = {
  ...
  dodoProCheckoutUrl: process.env.DODO_PRO_CHECKOUT_URL,
  dodoStudioCheckoutUrl: process.env.DODO_STUDIO_CHECKOUT_URL,
  dodoCustomerPortalUrl: process.env.DODO_CUSTOMER_PORTAL_URL,
